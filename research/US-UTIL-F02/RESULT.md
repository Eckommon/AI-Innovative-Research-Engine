...
created: 2026-09-11
issue: 96
gate: HOLD_US_UTIL_F02_LONGITUDINAL_COMPARABILITY
...
- utilities with Reliability+AMI+Service Territory in >=4/6 years: **0** (threshold 500)
- utilities with >=4 comparable IEEE-with-MED + complete-geography years: **0** (threshold 300)
- qualified repeated-support utility-year observations: **0** (threshold 2,000)
- qualified utility-year×county mappings: **0** (threshold 8,000)
- Reliability basis route identifiable all six years: **False**
...
**`HOLD_US_UTIL_F02_LONGITUDINAL_COMPARABILITY`**
